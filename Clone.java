...
//                 if that node is already visited, retrieve that node from visited array 
                //and add it as the adjacent node of prev copied node
//                 THIS IS THE POINT WHY WE USED NODE[] INSTEAD OF BOOLEAN[] ARRAY
    ...
    public Node cloneGraph(Node node) {
        ...
        //, because i have to add all the adjacent nodes of particular vertex, whether it's visited or not, so in the Node[] 
        //initially null is stored, if that node is visited, we will store the respective node at the index, 
